...
<script>
import Calendar from "../src/apsisx-calendar";
...
.back-to-today {
  ...
  left: 50px;
  top: 220px;
  box-shadow: 2px 0px 2px rgb(68, 146, 123, 0.2);
  position: absolute;
  left: 50px;
  top: 220px;
  height: 22px;
